...
int main(int argc, char *argv[])
{
	...
	if (init(argc, argv))
	{
		printf("Usage: %s [-f44|-f22|-f11|-f10|-f7|-f3] [-l] [-sin] <.CAQ inputfile>\n", argv[0]);
		printf("Options: -f44 force sampling freq to 44100 Hz\n");
		printf("         -f22 force sampling freq to 22050 Hz\n");
		printf("         -f11 force sampling freq to 11025 Hz\n");
		...
		printf("         -sin force SIN(X) output waveform\n");	      	  
		exit(1);
	}
