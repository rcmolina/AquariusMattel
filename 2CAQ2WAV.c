...
int main(int argc, char *argv[])
{
	...
	if (init(argc, argv))
	{
		printf("Usage: %s [-f44|-f22|-f11|-f10|-f7|-f3] [-l] [-n|-q] [-i] <.CAQ inputfile>\n", argv[0]);
		printf("Options: -f44 change sampling freq to 44100 Hz\n");
		...
		printf("         -f3 force sampling freq to 3600 Hz\n");
		printf("         -i invert outputlevel\n");	   	   	     	   	     	   	   	   
